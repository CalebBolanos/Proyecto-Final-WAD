 ...
 * @author calebbolanos
 */
@WebServlet(name = "CategoriaServletAdmin", urlPatterns = {"/administrador/CategoriaServlet"})
public class CategoriaServlet extends HttpServlet {
    ...
    private void agregarCategoria(HttpServletRequest request, HttpServletResponse response) {
        RequestDispatcher vista = request.getRequestDispatcher("categoriasForm.jsp");
        try {
    ...
    private void mostrarCategoria(HttpServletRequest request, HttpServletResponse response) {
        ...
        RequestDispatcher vista = request.getRequestDispatcher("datosCategoria.jsp");
