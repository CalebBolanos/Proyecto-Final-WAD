<%-- 
    ...
    Created on : 2 ene. 2022, 16:01:13
    Author     : calebbolanos
--%>
                ...
                <v-main class="grey lighten-2">
                    <v-container>
                        <v-row>
                                        ...
                                        <form method="POST" action="ProductoServlet?accion=guardar">
                                            <v-row>
                                                <v-col cols="12" class="mt-2">
                                                    <v-text-field readonly v-model="idProducto" name="txtIdProducto" label="ID de producto" type="number" outlined ></v-text-field>
                                                </v-col>
                                                <v-col cols="12">
                                                    <v-text-field v-model="nombreProducto" name="txtNombre" label="Nombre del producto" type="text" outlined  required :rules="reglas"></v-text-field>
                                                </v-col>
                                                <v-col cols="12">
                                                    <v-text-field v-model="descripcionProducto" name="txtDescripcion" label="Descripcion del producto" type="text" outlined  required :rules="reglas"></v-text-field>
                                                </v-col>
                                                <v-col cols="12">
                                                    <v-text-field v-model="precio" name="txtPrecio" label="Precio del producto" type="number" outlined  required :rules="reglas"></v-text-field>
                                                </v-col>
                                                <v-col cols="12">
                                                    <v-text-field v-model="existencia" name="txtExistencia" label="Cantidad disponible del producto" type="number" step="1" min="1" max="100" outlined  required :rules="reglas"></v-text-field>
                                                </v-col>
                                                <v-col cols="12">
                                                    <v-text-field v-model="stockMinimo" name="txtStock" label="Cantidad minima en stock del producto" type="number" step="1" min="10" max="100" outlined  required :rules="reglas"></v-text-field>
                                                </v-col>
                                                <v-col cols="12">
                                                    <v-text-field v-model="claveCategoria" name="txtClaveCategoria" label="Clave de la categoria" type="number" outlined  required :rules="reglas"></v-text-field>
                                                </v-col>
                                                ...
                                                <v-col cols="12">
                                                    ...
                                                    <v-btn color="primary" outlined class="mt-4" href="ProductoServlet?accion=listaDeCategorias">
                                                        Cancelar
                                                    </v-btn>
                                                </v-col>
                                            </v-row>
                            ...
                            <v-col cols="12" class="">
                                <h2 class="mt-2">Actualizar imagen</h2>
                            </v-col>
                            <v-col cols="12" class="">
                                <v-card class="pa-3 ">
                                    ...
                                    <v-card-text>
                                        <form method="POST" action="ProductoServlet?accion=actualizarImagen" enctype="multipart/form-data">
                                            <v-row>
                                                <v-col cols="12" class="mt-2">
                                                    <v-text-field readonly v-model="idProducto" name="txtIdProducto" label="ID de producto" type="number" outlined ></v-text-field>
                                                </v-col>
                                                <v-col cols="12">
                                                    <input name="imagen" type="file" accept=".jpeg,.png,.jpg,GIF" />
                                                </v-col>
