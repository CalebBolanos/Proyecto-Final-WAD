<%-- 
    ...
    Created on : 2 ene. 2022, 13:01:19
    Author     : calebbolanos
--%>
                                    ...
                                    <v-card-text>
                                        <form method="POST" action="CategoriaServlet?accion=guardar">
                                            <v-row>
                                                ...
                                                <v-col cols="12">
                                                    <v-text-field v-model="nombreCategoria" name="txtNombreCategoria" label="Nombre" type="text" outlined  required :rules="reglas"></v-text-field>
                                                </v-col>
                                                <v-col cols="12">
                                                    <v-text-field v-model="descripcionCategoria" name="txtDescripcionCategoria" label="Descripción" type="text" outlined  required :rules="reglas"></v-text-field>
                                                </v-col>
                                                ...
                                                <v-col cols="12">
                                                    ...
                                                    <v-btn color="primary" outlined class="mt-4" href="CategoriaServlet?accion=listaDeCategorias">
                                                        Cancelar
                                                    </v-btn>
                                                </v-col>
                                            </v-row>
