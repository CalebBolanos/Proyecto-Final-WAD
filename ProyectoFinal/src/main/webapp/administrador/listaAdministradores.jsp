<%-- 
    ...
    Created on : 2 ene. 2022, 21:13:02
    Author     : calebbolanos
--%>
                ...
                <v-main class="grey lighten-2">
                    <v-container>
                        <v-row>
                            ...
                            <v-col cols="8" class="">
                                <v-btn color="success" href="AdministradorServlet?accion=nuevo">Agregar Administrador</v-btn>


                            </v-col>
                            <v-col cols="4" class="">
                                <!--
                                <v-btn color="primary" href="AdministradorServlet?accion=graficar" target="_blank">Mostrar Gráfica</v-btn>
                                <v-btn color="error" href="AdministradorServlet?accion=verReporte" target="_blank">Mostrar Reporte</v-btn>
                                -->
                            </v-col>
                            <v-col cols="12" class="">
                                <v-simple-table>
                                    <template v-slot:default>
                                        ...
                                        <tbody>
                                            <c:forEach var="dto" items="${listaDeAdministradores}">
                                                <tr>
                                                    <td>
                                                        <v-btn color="warning" outlined small href="AdministradorServlet?accion=ver&id=<c:out value="${ dto.entidad.idAdministrador }"/>">
                                                            <c:out value="${ dto.entidad.idAdministrador }"/>
                                                        </v-btn>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <c:out value="${ dto.entidad.usuario }"/>
                                                    </td>
                                                    <td>
                                                        <v-btn color="error" outlined small href="AdministradorServlet?accion=eliminar&id=<c:out value="${ dto.entidad.idAdministrador }"/>">
                                                            Eliminar
                                                        </v-btn>
                                                    </td>
                                                    <td>
                                                        <v-btn color="success" outlined small href="AdministradorServlet?accion=actualizar&id=<c:out value="${ dto.entidad.idAdministrador }"/>">
                                                            Actualizar
                                                        </v-btn>
                                                    </td>
                                                </tr>
