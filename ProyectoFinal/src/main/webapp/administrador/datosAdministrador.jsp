<%-- 
    ...
    Created on : 2 ene. 2022, 22:41:19
    Author     : calebbolanos
--%>
                                ...
                                <v-card class="pa-3 ">
                                    <v-card-text>
                                            <v-row>
                                                ...
                                                <v-col cols="12">
                                                    <v-text-field readonly v-model="usuario" name="txtUsuario" label="Usuario" type="text" outlined  required :rules="reglas"></v-text-field>
                                                </v-col>
                                                <v-col cols="12">
                                                    <v-text-field readonly v-model="contrasena" name="txtContrasena" label="Contraseña" type="password" outlined  required :rules="reglas"></v-text-field>
                                                </v-col>
                                            </v-row>
                                    </v-card-text>
                                </v-card>
