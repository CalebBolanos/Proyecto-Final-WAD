                ...
                <v-main class="grey lighten-2">
                    <v-container>
                        <v-row>
                            ...
                            <v-col cols="8" class="">
                                <v-btn color="success" href="ClienteServlet?accion=nuevo">Agregar Cliente</v-btn>


                            </v-col>
                            <v-col cols="4" class="">
                                <!--
                                <v-btn color="primary" href="ClienteServlet?accion=graficar" target="_blank">Mostrar Gráfica</v-btn>
                                <v-btn color="error" href="ClienteServlet?accion=verReporte" target="_blank">Mostrar Reporte</v-btn>
                                -->
                            </v-col>
                            <v-col cols="12" class="">
                                <v-simple-table>
                                    <template v-slot:default>
                                        ...
                                        <tbody>
                                            <c:forEach var="dto" items="${listaDeClientes}">
                                                <tr>
                                                    <td>
                                                        <v-btn color="warning" outlined small href="ClienteServlet?accion=ver&id=<c:out value="${ dto.entidad.idUsuario }"/>">
                                                    ...
                                                    <td>
                                                        <c:out value="${ dto.entidad.direccion }"/>
                                                    </td>
                                                    <td>
                                                        <v-btn color="error" outlined small href="ClienteServlet?accion=eliminar&id=<c:out value="${ dto.entidad.idUsuario }"/>">
                                                            Eliminar
                                                        </v-btn>
                                                    </td>
                                                    <td>
                                                        <v-btn color="success" outlined small href="ClienteServlet?accion=actualizar&id=<c:out value="${ dto.entidad.idUsuario }"/>">
                                                            Actualizar
                                                        </v-btn>
                                                    </td>
                                                </tr>
