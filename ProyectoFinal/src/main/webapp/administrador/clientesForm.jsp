<%-- 
    ...
    Created on : 2 ene. 2022, 21:36:49
    Author     : calebbolanos
--%>
                    ...
                    <v-container>
                        <v-row>
                            ...
                            <v-col cols="12" class="">
                                <v-card class="pa-3 ">
                                    <v-card-text>
                                        <form method="POST" action="ClienteServlet?accion=guardar">
                                            <v-row>
                                                ...
                                                <v-col cols="12">
                                                    ...
                                                    <v-btn color="primary" outlined class="mt-4" href="ClienteServlet?accion=listaDeCategorias">
                                                        Cancelar
                                                    </v-btn>
                                                </v-col>
                                            </v-row>
