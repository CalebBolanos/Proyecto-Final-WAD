<%-- 
    ...
    Created on : 3 ene. 2022, 09:04:21
    Author     : calebbolanos
--%>
                                ...
                                <form method="POST" action="GuardarUsuario">
                                    <v-card class="elevation-0" rounded="lg">
                                        ...
                                        <v-card-text>
                                                ...
                                                <v-text-field v-model="claveUsuario" name="txtClaveUsuario" label="Escribe tu contraseña" outlined :append-icon="ver ? 'mdi-eye' : 'mdi-eye-off'" :type="ver ? 'text' : 'password'" @click:append="ver = !ver"  required :rules="reglas"
                                                          /></v-text-field>
                                                <v-text-field v-model="contrasena2" name="contrasena2" label="Vuelve a escribir tu contraseña" outlined :append-icon="ver2 ? 'mdi-eye' : 'mdi-eye-off'" :type="ver ? 'text' : 'password'" @click:append="ver = !ver" required
                                                          :rules="[claveUsuario == contrasena2 || 'Las contraseñas deben ser iguales']" /></v-text-field>
