<%-- 
    ...
    Created on : 2 ene. 2022, 22:07:24
    Author     : calebbolanos
--%>
        ...
        <div id="app">
            <v-app>
                <v-app-bar app style=" background-color: rgba(255, 255, 255, 0.5) !important; backdrop-filter: saturate(180%) blur(20px) !important;">
                    ...
                    <v-btn color="primary" text rounded href="ClienteServlet?accion=listaDeClientes">Clientes</v-btn>
                                ...
                                <v-card class="pa-3 ">
                                    <v-card-text>
                                            <v-row>
                                                ...
                                                <v-col cols="12">
                                                    <v-text-field readonly v-model="paterno" name="txtPaterno" label="Appelido Paterno" type="text" outlined  required :rules="reglas"></v-text-field>
                                                </v-col>
                                                <v-col cols="12">
                                                    <v-text-field readonly v-model="materno" name="txtMaterno" label="Apellido Materno" type="text" outlined  required :rules="reglas"></v-text-field>
                                                </v-col>
                                                <v-col cols="12">
                                                    <v-text-field readonly v-model="email" name="txtEmail" label="Correo electrónico" type="email" outlined  required :rules="reglas"></v-text-field>
                                                </v-col>
                                                <v-col cols="12">
                                                    <v-text-field readonly v-model="nombreUsr" name="txtNombreUsuario" label="Nombre de usuario" type="text"  outlined  required :rules="reglas"></v-text-field>
                                                </v-col>
                                                <v-col cols="12">
                                                    <v-text-field readonly v-model="claveUsuario" name="txtClaveUsuario" label="Contraseña" type="password" outlined  required :rules="reglas"></v-text-field>
                                                </v-col>
                                                <v-col cols="12">
                                                    <v-text-field readonly v-model="direccion" name="txtDireccion" label="Dirección" type="text" outlined  required :rules="reglas"></v-text-field>
                                                </v-col>
                                            </v-row>
                                    </v-card-text>
                                </v-card>
