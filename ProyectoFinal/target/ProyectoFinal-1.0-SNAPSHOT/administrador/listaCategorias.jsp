<%-- 
    ...
    Created on : 2 ene. 2022, 12:08:21
    Author     : calebbolanos
--%>
                ...
                <v-main class="grey lighten-2">
                    <v-container>
                        <v-row>
                            ...
                            <v-col cols="8" class="">
                                <v-btn color="success" href="CategoriaServlet?accion=nuevo">Crear Categoria</v-btn>
                                    ...
                                    <template v-slot:default>
                                        ...
                                        <tbody>
                                            <c:forEach var="dto" items="${listaDeCategorias}">
                                                <tr>
                                                    <td>
                                                        <v-btn color="warning" outlined small href="CategoriaServlet?accion=ver&id=<c:out value="${ dto.entidad.idCategoria }"/>">
                                                    ...
                                                    <td>
                                                        <v-btn color="error" outlined small href="CategoriaServlet?accion=eliminar&id=<c:out value="${ dto.entidad.idCategoria }"/>">
                                                            Eliminar
                                                        </v-btn>
                                                    </td>
                                                    <td>
                                                        <v-btn color="success" outlined small href="CategoriaServlet?accion=actualizar&id=<c:out value="${ dto.entidad.idCategoria }"/>">
                                                            Actualizar
                                                        </v-btn>
                                                    </td>
                                                </tr>
